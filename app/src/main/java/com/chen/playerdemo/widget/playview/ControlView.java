...
import com.chen.playerdemo.utils.TimeFormater;
import com.chen.playerdemo.widget.playview.interfaces.ViewAction;
import com.chen.playerdemo.widget.playview.other.QualityItem;
...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    public void updateDownloadBtn() {
        if (mAliyunScreenMode == AliyunScreenMode.Full || "localSource".equals(Constants.PLAY_PARAM_TYPE)) {
            mTitleDownload.setVisibility(GONE);
        } else if (mAliyunScreenMode == AliyunScreenMode.Small || "vidsts".equals(Constants.PLAY_PARAM_TYPE)) {
...
//        }
    ...
    private void updateSeekBarTheme(AliyunVodPlayerView.Theme theme) {
        ...
        if (theme == AliyunVodPlayerView.Theme.Blue) {
            ...
            thumbResId = (R.mipmap.alivc_seekbar_thumb_blue);
    ...
    private void updateScreenModeBtn() {
        if (mAliyunScreenMode == AliyunScreenMode.Full) {
            mScreenModeBtn.setImageResource(R.mipmap.alivc_screen_mode_small);
        } else {
