...
public class ArcProgressView extends View {
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.white));//设置画笔颜色
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        canvas.drawText(stepNumber, centerX, getHeight() / 2, vTextPaint);
        vTextPaint.setTextSize(numberTextSize / 3);
        canvas.drawText("污染指数", centerX, getHeight() / 2 + bounds_Number.height(), vTextPaint);
    }
