package com.chen.playerdemo.widget.playview;
...
import com.chen.playerdemo.utils.ImageLoader;
import com.chen.playerdemo.utils.NetWatchdog;
import com.chen.playerdemo.utils.OrientationWatchDog;
import com.chen.playerdemo.utils.ScreenUtils;
import com.chen.playerdemo.utils.ToastUtils;
import com.chen.playerdemo.widget.playview.gesture.GestureDialogManager;
import com.chen.playerdemo.widget.playview.gesture.GestureView;
import com.chen.playerdemo.widget.playview.interfaces.ViewAction;
import com.chen.playerdemo.widget.playview.other.QualityView;
import com.chen.playerdemo.widget.playview.other.SpeedValue;
import com.chen.playerdemo.widget.playview.other.SpeedView;
import com.chen.playerdemo.widget.playview.theme.ITheme;
...
public class AliyunVodPlayerView extends RelativeLayout implements ITheme {
        ...
        mControlView.setOnDownloadClickListener(new ControlView.OnDownloadClickListener() {
            ...
            public void onDownloadClick() {
                ...
                if ("localSource".equals(Constants.PLAY_PARAM_TYPE)) {
                    ToastUtils.show(getResources().getString(R.string.slivc_not_support_url));
                    return;
                }
    ...
    private boolean isLocalSource() {
        String scheme = null;
        if ("vidsts".equals(Constants.PLAY_PARAM_TYPE)) {
            return false;
        }
        if ("localSource".equals(Constants.PLAY_PARAM_TYPE)) {
            Uri parse = Uri.parse(Constants.PLAY_PARAM_URL);
