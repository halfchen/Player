...
import com.chen.playerdemo.presenter.HistoricalPresenter;
 ...
 * 总排行
 */
public class HistoricalFragment extends BaseFragment<HistoricalPresenter> implements HistoricalContract.View {
    ...
    protected void initView(View view) {
        mPresenter = new HistoricalPresenter();
        mPresenter.attachView(this);
        initAdapter();
        mPresenter.getHistorical(start);
