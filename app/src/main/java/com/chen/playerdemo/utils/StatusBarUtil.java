...
public class StatusBarUtil {
    ...
    /**
     * 增加View的paddingLeft,增加的值为状态栏高度
     */
    public static void setPaddingL(Context context, View view) {
        if (Build.VERSION.SDK_INT >= MIN_API) {
            view.setPadding(getStatusBarHeight(context), 0,
                    0, 0);
        }
    }

    /**
     * 增加View的paddingLeft Right,增加的值为状态栏高度
     */
    public static void setPaddingR(Context context, View view) {
        if (Build.VERSION.SDK_INT >= MIN_API) {
            view.setPadding(0, 0,
    ...
    public static void setPadding(Context context, View view) {
        if (Build.VERSION.SDK_INT >= MIN_API) {
            view.setPadding(0, getStatusBarHeight(context),
                    0, 0);
        }
    }

    public static void setNoPadding(Context context, View view) {
        if (Build.VERSION.SDK_INT >= MIN_API) {
            view.setPadding(0, 0,
                    0, 0);
        }
